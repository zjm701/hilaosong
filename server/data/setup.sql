--用户信息表
--id, info, type, user_id)
DROP TABLE T_CATER_HISTORYUSERINFO;
create table T_CATER_HISTORYUSERINFO
(
  id      VARCHAR2(32),
...
delete from T_CATER_HISTORYUSERINFO;
alter table T_CATER_HISTORYUSERINFO modify types number;
CREATE SEQUENCE  T_CATER_HISTORYUSERINFO_SEQ 
MINVALUE 1 MAXVALUE 9223372036854775807 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
